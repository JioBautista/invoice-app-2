...
export default async function Modal({ id }) {
  ...
  return (
    <div className="absolute md:inset-x-1/4 bg-white text-black rounded-md md:p-8 shadow-2xl z-10 p-5 space-y-3 left-5 right-5 dark:bg-[#1E2139] dark:text-white">
      ...
      <div className="flex items-center justify-end gap-2">
        <form action={cancelButton}>
          <button
            type="submit"
            className="rounded-full px-4 py-3 bg-gray-200 text-gray-500 dark:bg-[#252945] dark:text-white"
          >
            Cancel
          </button>
        </form>
